...
2. Inspect queue discipline, churn, and blocked actions.
3. Inspect behavior profiles and training readiness.
4. Summarize the highest-signal findings and next guarded fixes.
